...
@class GADNAdSource, GADNBannerAd, GADNCorrelator, GADNEventContext, GADNObserverCollection, GADNRefreshTimer, GADNTargeting, GADNVideoController, NSArray, NSObject<OS_dispatch_queue>, NSString, UIViewController;
