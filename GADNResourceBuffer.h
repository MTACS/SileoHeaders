...
@class GADNURLSessionTransaction, NSDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSOperationQueue, NSString, NSURL, NSURLRequest, NSURLSession, NSURLSessionDataTask;
