...
#import "GADOSDKCoreGMSGHandlerDelegate.h"
#import "GADOSDKCoreWebViewNotification.h"

@class GADOSDKCoreWebView, GADOWebViewConfiguration, NSArray, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString;
