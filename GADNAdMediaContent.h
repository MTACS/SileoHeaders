...
@class GADNEventContext, GADNInternalNativeAd, GADNNativeAdImage, GADNObserverCollection, GADNViewVisibilityMonitor, GADNWebAdView, NSDictionary, NSMutableArray, NSObject<OS_dispatch_queue>, NSString, UIImageView, UIView;
