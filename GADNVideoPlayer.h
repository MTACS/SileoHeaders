...
@class AVPlayer, AVPlayerItem, GADNAVPlayerItemLogger, GADNObserverCollection, GADNVideoConfiguration, GADNWebAdView, NSMutableArray, NSNumber, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_semaphore>, NSOperationQueue, NSString;
