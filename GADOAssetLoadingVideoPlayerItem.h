...
@class AVAssetResourceLoadingRequest, AVPlayerItem, GADOResourceCache, GADOVideoAssetLoader, GADOVideoConfiguration, GADOVideoPlayer, NSObject<OS_dispatch_queue>, NSString, NSTimer, NSURL;
