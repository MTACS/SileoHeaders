...
#import "GADONativeAdDelegateInternal.h"
#import "GADONativeAdUnconfirmedClickDelegate.h"

@class GADOMediaContent, GADONativeAd<GADONativeAdSourceAttributing><GADOOverlayViewSource>, GADONativeAdImage, GADOVideoController, NSArray, NSDecimalNumber, NSDictionary, NSObject<OS_dispatch_queue>, NSString, UIViewController;
