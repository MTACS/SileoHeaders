...
#import "GADNFramerateObserver.h"

@class GADNMemoryUtilizationMonitor, GADNNetworkUtilizationMonitor, GADNScheduler, NSArray, NSDate, NSDictionary, NSMutableArray, NSObject<OS_dispatch_queue>, NSString;
