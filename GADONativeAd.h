...
@class GADMediatedNativeAd, GADONativeAdViewPolicy, GADONativeClickConfirmingViewMonitor, GADOSlot, NSArray, NSDictionary, NSMutableArray, NSMutableSet, NSObject<OS_dispatch_queue>, NSSet, NSString, NSURL, UIViewController;
